        ...
        <tr>
          <td><form id="form1" name="form1" method="post" action="">
              <table width="105%" height="80%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="30" align="center" bgcolor="#333333"><label for="label2"><a href="http://www.xnyy.cn/" target="_blank"><strong>西南医院</strong></a></label></td>
                </tr>
                <tr>
                  <td height="30" align="center" bgcolor="#333333"><a href="http://www.who.org/"><strong>世界卫生组织</strong></a></td>
                </tr>
              </table>
          </form></td>
        </tr>
    ...
    <div class="story">
      <form id="form2" runat="server">
        <table width="90%"  border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#F55B1A">
          <tr>
            <td height="28" colspan="2" bgcolor="#F55B1A"><div align="center"><span class="STYLE8">个人信息中心</span></div></td>
          </tr>
          <tr>
            <td width="130" height="28" bgcolor="#FFFFFF"><span class="STYLE8">帐号</span><span class="STYLE8"></span></td>
            <td width="607" colspan="-5" bgcolor="#FFFFFF"><asp:Label ID="userID" runat="server" Text=""></asp:Label>&nbsp;</td>
          </tr>
          <tr>
            <td height="28" bgcolor="#FFFFFF"><label><span class="STYLE8">姓名</span></label></td>
            <td colspan="-5" bgcolor="#FFFFFF"><asp:Label ID="userNAME" runat="server" Text=""></asp:Label>&nbsp;</td>
          </tr>
          <tr>
            <td height="28" bgcolor="#FFFFFF"><label><span class="STYLE8">身份证号</span></label></td>
            <td colspan="-5" bgcolor="#FFFFFF"><asp:Label ID="IDCard" runat="server" Text=""></asp:Label>&nbsp;</td>
          </tr>
          <tr>
            <td height="28" bgcolor="#FFFFFF"><label><span class="STYLE8">银行卡号</span></label></td>
            <td colspan="-5" bgcolor="#FFFFFF"><asp:Label ID="BankCardID" runat="server" Text=""></asp:Label>&nbsp;</td>
          </tr>
          <tr>
            <td height="28" bgcolor="#FFFFFF"><label><span class="STYLE8">电话号码</span></label></td>
